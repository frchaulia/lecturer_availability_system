...
export default function Navbar() {
  return (
    <div className="flex gap-5 items-center my-auto text-xl font-bold text-yellow-400 flex-wrap z-20">
      ...
      <div className="flex-auto my-auto"><Link href="../../lecturer/profile">PROFILE</Link></div>
      <div className="flex-auto my-auto"><Link href="../../lecturer/statistic">STATISTIC</Link></div>
    </div>
  );
}
